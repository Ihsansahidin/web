<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['id_menejer'] == "" || $_REQUEST['admin'] == ""){
                ...
                if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                    ...
                    if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                        ...
                        if(!preg_match("/^[0-9. -]*$/", $id_menejer)){
                            $_SESSION['nipuser'] = 'Form ID menejer hanya boleh mengandung karakter angka, spasi dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                                ...
                                if($result > 0){
                                    ...
                                    if(strlen($username) < 5){
                                        ...
                                        if(strlen($password) < 5){
                                            ...
                                            $query = mysqli_query($config, "INSERT INTO tbl_user(username,password,nama,id_menejer,admin) VALUES('$username',MD5('$password'),'$nama','$id_menejer','$admin')");
                ...
                <form class="col s12" method="post" action="?page=sett&sub=usr&act=add">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="id_menejer" type="text" class="validate" name="id_menejer" required>
                                <?php
                                    if(isset($_SESSION['iduser'])){
                                        $iduser = $_SESSION['iduser'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$iduser.'</div>';
                                        unset($_SESSION['nipuser']);
                                    }
                                ?>
                            <label for="id_menejer">ID pengguna</label>
                        </div>
                        <div class="input-field col s6">
