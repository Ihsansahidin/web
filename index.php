                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Pengelolaan Surat | <b>PDAM TIRTA MUSI PALEMBANG</b></h5>
                            <?php echo '<img id="logo" src="upload/'.$data['logo'].'">';?>
                            <h4 class="center" id="PDAM">
                            <?php echo ''.$data['nama'].'';?>
                            </h4>
                            <div class="batas"></div>
                        </div>
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nama, id_menejer, admin FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");

                                if(mysqli_num_rows($query) > 0){
                                    list($id_user, $username, $nama, $id_menejer, $admin) = mysqli_fetch_array($query);

                                    //buat session
                                    $_SESSION['id_user'] = $id_user;
                                    $_SESSION['username'] = $username;
                                    $_SESSION['nama'] = $nama;
                                    $_SESSION['id_menejer'] = $id_menejer;
