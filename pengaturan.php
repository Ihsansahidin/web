        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['menejer'] == "" || $_REQUEST['id_menejer'] == ""
                        ...
                        $menejer = $_REQUEST['menejer'];
                        $id_menejer = $_REQUEST['id_menejer'];
                            ...
                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $menejer)){
                                            $_SESSION['menejer'] = 'Form Nama menejer hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $id_menejer)){
                                                $_SESSION['id_menejer'] = 'Form ID menejer hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',menejer='$menejer',id_menejer='$id_menejer',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',menejer='$menejer',id_menejer='$id_menejer',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        ...
                                        <i class="material-icons prefix md-prefix">company</i>
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="institusi" type="text" class="validate" name="institusi" value="<?php echo $row['institusi']; ?>" required>
                                            ...
                                            ?>
                                        <label for="institusi">Nama prusahaan</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="menejer" type="text" class="validate" name="menejer" value="<?php echo $row['menejer']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['menejer'])){
                                                    $menejer = $_SESSION['menejer'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$menejer.'</div>';
                                                    unset($_SESSION['menejer']);
                                                }
                                            ?>
                                        <label for="menejer">Nama menejer</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="id_menejer" type="text" class="validate" name="id_menejer" value="<?php echo $row['id_menejer']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['id_menejer'])){
                                                    $id_menejer = $_SESSION['id_menejer'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$id_menejer.'</div>';
                                                    unset($_SESSION['id_menejer']);
                                                }
                                            ?>
                                        <label for="id_menejers">ID menejer</label>
                                    </div>
                                    <div class="input-field col s6">
