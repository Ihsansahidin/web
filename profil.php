    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['sub'])){
            ...
            if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['id_menejer'] == ""){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                        ...
                        if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                            ...
                            if(!preg_match("/^[0-9 -]*$/", $id_menejer)){
                                $_SESSION['epid'] = 'Form id_menejer hanya boleh mengandung karakter angka, spasi dan minus(-)';
                                header("Location: ./admin.php?page=pro&sub=pass");
                                die();
                            } else {
                                ...
                                if(strlen($username) < 5){
                                    ...
                                    if(strlen($password) < 5){
                                        ...
                                        if(mysqli_num_rows($query) > 0){
                                            $do = mysqli_query($config, "UPDATE tbl_user SET username='$username', password=MD5('$password'), nama='$nama', id_menejer='$id_menejer' WHERE id_user='$id_user'");
